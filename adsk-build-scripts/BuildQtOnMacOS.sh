...
# Copy some corresponding files to the Compilers folder
  ...
  # install_name_tool -add_rpath @loader_path lupdate-pro
	...
	# codesign --force --deep -s - lconvert
	# codesign --force --deep -s - lrelease
	# codesign --force --deep -s - lupdate
	# codesign --force --deep -s - qmake
	...
	# #install_name_tool -add_rpath @loader_path qtmoc
	# install_name_tool -add_rpath @loader_path rcc
	# install_name_tool -add_rpath @loader_path uic
	# codesign --force --deep -s - lupdate-pro
	# codesign --force --deep -s - lprodump
	# codesign --force --deep -s - qmlcachegen
	# codesign --force --deep -s - mocwrapper
	# codesign --force --deep -s - rcc
	# codesign --force --deep -s - uic
	# codesign --force --deep -s - moc
	# codesign --force --deep -s - qtmoc
