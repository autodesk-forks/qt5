...
rm -f ${CONFIG_PREFIX}/translations/assistant_*.qm
rm -f ${CONFIG_PREFIX}/translations/designer_*.qm
rm -f ${CONFIG_PREFIX}/translations/linguist_*.qm
rm -f ${CONFIG_PREFIX}/translations/qt_help_*.qm
